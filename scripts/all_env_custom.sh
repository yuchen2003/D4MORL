...
# # mod custom
# CUDA_VISIBLE_DEVICES=1 python experiment.py --dir experiment_runs/all_expert_custom --env MO-Swimmer-v2 --data_mode _formal --concat_state_pref 1 --concat_rtg_pref 0 --concat_act_pref 0 --mo_rtg True --seed 1 --dataset expert_custom --model_type mod --num_steps_per_iter 200000 --max_iters 2 --use_p_bar True
