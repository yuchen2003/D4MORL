...
class MOGaussianInvDynDiffusion(nn.Module):
    ...
    def get_loss_weights(self, discount): # FIXME
        '''
            sets loss coefficients for trajectory
