...
# python collect_env_new.py --env_name MO-Hopper-v3 --collect_type amateur --preference_type custom --num_traj 50000 &
# python collect_env_new.py --env_name MO-Hopper-v3 --collect_type expert --preference_type custom --num_traj 50000 &
# wait &
...
python collect_env_new.py --env_name MO-Ant-v2 --collect_type amateur --preference_type custom --num_traj 50000 &
python collect_env_new.py --env_name MO-Ant-v2 --collect_type expert --preference_type custom --num_traj 50000 &
wait &
...
python collect_env_new.py --env_name MO-HalfCheetah-v2 --collect_type amateur --preference_type custom --num_traj 50000 &
python collect_env_new.py --env_name MO-HalfCheetah-v2 --collect_type expert --preference_type custom --num_traj 50000 &
wait &
...
python collect_env_new.py --env_name MO-Swimmer-v2 --collect_type amateur --preference_type custom --num_traj 50000 &
python collect_env_new.py --env_name MO-Swimmer-v2 --collect_type expert --preference_type custom --num_traj 50000 &
wait &
...
python collect_env_new.py --env_name MO-Walker2d-v2 --collect_type amateur --preference_type custom --num_traj 50000 &
python collect_env_new.py --env_name MO-Walker2d-v2 --collect_type expert --preference_type custom --num_traj 50000 &
wait